...
* Tweak - WordPress 6.6.1 support
* Tweak - Wording improvement in settings
* Tweak - Simplified the parcel machine selectbox size in checkout
* Fix - Fixed undefined array key warning

= 3.5.2 2024-06-25 =
* Tweak - Payment method preselection support in iframe
* Tweak - PHP 8.3 support
* Tweak - Ordering of card payment methods
* Fix - Incorrect WPML endpoint when redirecting from payment
* Fix - XSS vulnerability

= 3.5.1 2024-05-28 =
* Tweak - Updated supported WordPress and WooCommerce versions
* Tweak - Improved flow for checking order payment
* Fix - Fixed undefined array key warning

= 3.5.0 2024-05-22 =
* Feature - Support for WooCommerce Blocks checkout
* Tweak - Shipment registration flow without credentials
* Tweak - Adjust the free shipping calculation
* Tweak - Removed pay later promotion options
* Tweak - Expiration times for transients
* Tweak - Additional app info fields to requests
* Tweak - Introduction of Shipping+ instead of TMS
* Tweak - Improved transaction and amount matching
* Fix - Incorrect query prefix
* Fix - Duplicate parcel machine list initializations
* Fix - Use of non-existing class
